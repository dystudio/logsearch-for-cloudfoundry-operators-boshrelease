...
describe "Diego component logs" do
  ...
  describe "Route emitter log parsing rules" do
    when_parsing_log(
      '@source' => { 'program' => 'route_emitter' },
      '@message' => '{"timestamp":"1466769728.520450354","source":"rep","message":"rep.executing-container-operation.starting","log_level":1,"data":{"container-guid":"6dcf9128-3762-4624-839f-0e640cec2ff1-6a9abb10-0757-4bd7-847b-623fb28b4661-9469e7e3-92b9-4305-4a75-882f1b04944d","session":"61"}}'
    ) do
      ...
      it "parses the message as json" do
        expect(subject["route_emitter"]["data"]["session"]).to eq "61"
      end
  ...
  describe "alternate formats" do
    context 'when log_level is set to a word' do
      when_parsing_log(
        '@source' => { 'program' => 'rep' },
        '@message' => '{"timestamp":"2016-06-24T05:02:08.520450354-07:00","source":"rep","message":"rep.executing-container-operation.starting","log_level":"2","data":{"container-guid":"6dcf9128-3762-4624-839f-0e640cec2ff1-6a9abb10-0757-4bd7-847b-623fb28b4661-9469e7e3-92b9-4305-4a75-882f1b04944d","session":"61"}}'
      ) do

        it "finds the log level when present at @level key" do
          expect(subject["@level"]).to eq "ERROR"
        end
      end
    end

    context 'when level is set to a word' do
      when_parsing_log(
        '@source' => { 'program' => 'route_emitter' },
    ...
    context 'when level is set to a number' do
      when_parsing_log(
        '@source' => { 'program' => 'bbs' },
        '@message' => '{"timestamp":"2016-06-24T05:02:08.520450354-07:00","source":"rep","message":"rep.executing-container-operation.starting","level":"3","data":{"container-guid":"6dcf9128-3762-4624-839f-0e640cec2ff1-6a9abb10-0757-4bd7-847b-623fb28b4661-9469e7e3-92b9-4305-4a75-882f1b04944d","session":"61"}}'
      ) do
    ...
    context 'when timestamp is iso8601' do
      when_parsing_log(
        '@source' => { 'program' => 'rep' },
        '@message' => '{"timestamp":"2016-06-24T05:02:08.520450354-07:00","source":"rep","message":"rep.executing-container-operation.starting","level":"DEBUG","data":{"container-guid":"6dcf9128-3762-4624-839f-0e640cec2ff1-6a9abb10-0757-4bd7-847b-623fb28b4661-9469e7e3-92b9-4305-4a75-882f1b04944d","session":"61"}}'
      ) do
